...
Slopes have C.O.O.L. ratings, which stants for Conversion Of Only Letters. Based on the incline, (2, 8, 10, or 16) and the name provided, assign a C.O.O.L. rating.
 ...
 */
namespace ASCII_ing_on_the_Alps
{
    internal class Program
    {
        public static void Main(string[] args)
        {
            Console.Write(AsciiResort.Slope.DetermineCool(10,"Decimal"));
        }
    }
}
...
namespace AsciiResort
{
    public static class Slope
    {
        public static string DetermineCool(int incline, string name)
        {
            ...
            {
                sum += Convert.ToByte(symbol);
            }

            return Convert.ToString(sum, incline);
        }
    }
}